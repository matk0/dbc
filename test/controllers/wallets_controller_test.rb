...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { address: @wallet.address, name: @wallet.name, on_chain_properties: @wallet.on_chain_properties } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { address: @wallet.address, name: @wallet.name, on_chain_properties: @wallet.on_chain_properties } }
